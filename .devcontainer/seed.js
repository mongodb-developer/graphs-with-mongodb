...
const DATA = {
  ...
  // ── B. TREE PATTERN ─────────────────────────────────────────────────────
  // DC hierarchy: dc1 (root) → dc2 → dc4, dc5
  //                          → dc3 (leaf)
  tree_data_centers: [
    { _id: 'dc1', name: 'Data Center West',    location: 'San Jose, CA',    features: ['Tier III certified', '24/7 staffing', 'Redundant power'],   parent: null,  ancestors: [] },
    { _id: 'dc2', name: 'Data Center South',   location: 'Los Angeles, CA', features: ['Tier III certified', 'On-site security', '25GbE uplink'],   parent: 'dc1', ancestors: ['dc1'] },
    { _id: 'dc3', name: 'Data Center North',   location: 'Seattle, WA',     features: ['Tier II certified', '24/7 staffing', 'UPS backup'],          parent: 'dc1', ancestors: ['dc1'] },
    { _id: 'dc4', name: 'Data Center Central', location: 'Denver, CO',      features: ['Tier III certified', 'Redundant power', 'Fire suppression'], parent: 'dc2', ancestors: ['dc1', 'dc2'] },
    { _id: 'dc5', name: 'Data Center East',    location: 'Dallas, TX',      features: ['Tier IV certified', '24/7 staffing', 'Biometric access'],    parent: 'dc2', ancestors: ['dc1', 'dc2'] },
  ],
  tree_routers: [
    { _id: 'r1',  hostname: 'router-west-1', data_center: 'dc1', location: 'San Jose, CA',    features: ['BGP', 'IPv6', 'QoS'],          ancestors: ['dc1'] },
    { _id: 'r2',  hostname: 'router-west-2', data_center: 'dc1', location: 'San Jose, CA',    features: ['BGP', 'OSPF', 'Low Latency'],  ancestors: ['dc1'] },
    { _id: 'r3',  hostname: 'router-la-1',   data_center: 'dc2', location: 'Los Angeles, CA', features: ['MPLS', 'BGP', 'IPv6'],         ancestors: ['dc1', 'dc2'] },
    { _id: 'r4',  hostname: 'router-la-2',   data_center: 'dc2', location: 'Los Angeles, CA', features: ['MPLS', 'QoS', 'OSPF'],         ancestors: ['dc1', 'dc2'] },
    { _id: 'r5',  hostname: 'router-sea-1',  data_center: 'dc3', location: 'Seattle, WA',     features: ['BGP', 'IPv6', 'OSPF'],         ancestors: ['dc1', 'dc3'] },
    { _id: 'r6',  hostname: 'router-sea-2',  data_center: 'dc3', location: 'Seattle, WA',     features: ['OSPF', 'Low Latency', 'MPLS'], ancestors: ['dc1', 'dc3'] },
    { _id: 'r7',  hostname: 'router-den-1',  data_center: 'dc4', location: 'Denver, CO',      features: ['BGP', 'OSPF', 'IPv6'],         ancestors: ['dc1', 'dc2', 'dc4'] },
    { _id: 'r8',  hostname: 'router-den-2',  data_center: 'dc4', location: 'Denver, CO',      features: ['MPLS', 'QoS', 'OSPF'],         ancestors: ['dc1', 'dc2', 'dc4'] },
    { _id: 'r9',  hostname: 'router-dal-1',  data_center: 'dc5', location: 'Dallas, TX',      features: ['BGP', 'IPv6', 'MPLS'],         ancestors: ['dc1', 'dc2', 'dc5'] },
    { _id: 'r10', hostname: 'router-dal-2',  data_center: 'dc5', location: 'Dallas, TX',      features: ['BGP', 'QoS', 'Low Latency'],   ancestors: ['dc1', 'dc2', 'dc5'] },
  ],
  tree_network_cards: [
    ...
    { _id: 'nc4',  serial_number: 'NC-10004', router: 'r3',  location: 'Los Angeles, CA', features: ['100GbE', 'DPDK'],                  port_count: 2, speed_gbps: 100, ancestors: ['dc1', 'dc2', 'r3'] },
    { _id: 'nc5',  serial_number: 'NC-10005', router: 'r3',  location: 'Los Angeles, CA', features: ['25GbE', 'RDMA', 'SR-IOV'],         port_count: 4, speed_gbps: 25,  ancestors: ['dc1', 'dc2', 'r3'] },
    { _id: 'nc6',  serial_number: 'NC-10006', router: 'r4',  location: 'Los Angeles, CA', features: ['10GbE', 'Low Latency'],            port_count: 8, speed_gbps: 10,  ancestors: ['dc1', 'dc2', 'r4'] },
    { _id: 'nc7',  serial_number: 'NC-10007', router: 'r5',  location: 'Seattle, WA',     features: ['25GbE', 'IPv6 offload'],           port_count: 2, speed_gbps: 25,  ancestors: ['dc1', 'dc3', 'r5'] },
    { _id: 'nc8',  serial_number: 'NC-10008', router: 'r5',  location: 'Seattle, WA',     features: ['100GbE', 'DPDK', 'SR-IOV'],        port_count: 2, speed_gbps: 100, ancestors: ['dc1', 'dc3', 'r5'] },
    { _id: 'nc9',  serial_number: 'NC-10009', router: 'r6',  location: 'Seattle, WA',     features: ['10GbE', 'QoS offload'],            port_count: 4, speed_gbps: 10,  ancestors: ['dc1', 'dc3', 'r6'] },
    { _id: 'nc10', serial_number: 'NC-10010', router: 'r7',  location: 'Denver, CO',      features: ['25GbE', 'RDMA'],                   port_count: 4, speed_gbps: 25,  ancestors: ['dc1', 'dc2', 'dc4', 'r7'] },
    { _id: 'nc11', serial_number: 'NC-10011', router: 'r7',  location: 'Denver, CO',      features: ['10GbE', 'SR-IOV'],                 port_count: 8, speed_gbps: 10,  ancestors: ['dc1', 'dc2', 'dc4', 'r7'] },
    { _id: 'nc12', serial_number: 'NC-10012', router: 'r8',  location: 'Denver, CO',      features: ['100GbE', 'DPDK'],                  port_count: 2, speed_gbps: 100, ancestors: ['dc1', 'dc2', 'dc4', 'r8'] },
    { _id: 'nc13', serial_number: 'NC-10013', router: 'r9',  location: 'Dallas, TX',      features: ['25GbE', 'RDMA', 'SR-IOV'],         port_count: 4, speed_gbps: 25,  ancestors: ['dc1', 'dc2', 'dc5', 'r9'] },
    { _id: 'nc14', serial_number: 'NC-10014', router: 'r9',  location: 'Dallas, TX',      features: ['10GbE', 'Low Latency'],            port_count: 4, speed_gbps: 10,  ancestors: ['dc1', 'dc2', 'dc5', 'r9'] },
    { _id: 'nc15', serial_number: 'NC-10015', router: 'r10', location: 'Dallas, TX',      features: ['25GbE', 'QoS offload'],            port_count: 2, speed_gbps: 25,  ancestors: ['dc1', 'dc2', 'dc5', 'r10'] },
  ],
